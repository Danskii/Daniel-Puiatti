              ...
              <Col xs={12} sm={6} md={6} lg={4}>
                <Card>
                  <Card.Body>
                    <Card.Img
                      variant="top"
                      src={require("../images/icons/web-development.png")}
                    />
                  </Card.Body>
                  <Card.Body>
              ...
              <Col xs={12} sm={6} md={6} lg={4}>
                <Card>
                  <Card.Body>
                    <Card.Img
                      variant="top"
                      src={require("../images/icons/seo.png")}
                    />
                  </Card.Body>
                  <Card.Body>
              ...
              <Col xs={12} sm={6} md={6} lg={4}>
                <Card>
                  <Card.Body>
                    <Card.Img
                      variant="top"
                      src={require("../images/icons/online-advertising.png")}
                    />
                  </Card.Body>
                  <Card.Body>
              ...
              <Col xs={12} sm={6} md={6} lg={4}>
                <Card>
                  <Card.Body>
                    <Card.Img
                      variant="top"
                      src={require("../images/icons/social-media.png")}
                    />
                  </Card.Body>
                  <Card.Body>
                    <Card.Title>Social Media</Card.Title>
                    <Card.Text>
                      Take your brand awareness to the next level with engaging
                      and vibrant content.
                    </Card.Text>
                  </Card.Body>
                </Card>
              ...
              <Col xs={12} sm={6} md={6} lg={4}>
                <Card>
                  <Card.Body>
                    <Card.Img
                      variant="top"
                      src={require("../images/icons/design.png")}
                    />
                  </Card.Body>
                  <Card.Body>
              ...
              <Col xs={12} sm={6} md={6} lg={4}>
                <Card>
                  <Card.Body>
                    <Card.Img
                      variant="top"
                      src={require("../images/icons/copy-writing.png")}
                    />
                  </Card.Body>
                  <Card.Body>
